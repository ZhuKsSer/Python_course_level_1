...
for i in lst:
   if i > 0 and (math.sqrt(i)) % 1 == 0:
        new_lst.append(int(math.sqrt(i)))
print(new_lst)
...
new_date =  (date.split('.')) # исходную строку разрезали на части по пробелам, в итоге получилось 3 элемента: i[0] = day, i[1] = month, i[3] = year
...
output = np.random.randint(0, 10, 20).tolist()
print(output)
